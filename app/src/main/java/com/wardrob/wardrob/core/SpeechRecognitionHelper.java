...
public class SpeechRecognitionHelper
{
    ...
    public static final int REQ_CODE_SPEECH_INPUT_NEW = 101;
     ...
     */
    public static void run(Activity callingActivity, int REQ_CODE_SPEECH_INPUT)
    {
        ...
        if (isSpeechRecognitionActivityPresented(callingActivity) == true)
        {
            ...
            startRecognitionActivity(callingActivity, REQ_CODE_SPEECH_INPUT);
        }
        else
        {
     ...
     */
    private static void startRecognitionActivity(Activity callerActivity, int REQ_CODE_SPEECH_INPUT) {
        ...
        callerActivity.startActivityForResult(intent, REQ_CODE_SPEECH_INPUT);
    }
