...
//}
    public static String apiRequest(String lat, String lng)
    {
        ...
        //Timber.d("[apiRequest] This is URL: " + sb.toString());
        return sb.toString();
    }

    public static String apiRequestBiCityId(String id)
    {
        StringBuilder sb = new StringBuilder(API_LINK);
        sb.append(String.format("?id=%s&APPID=%s&units-metric",id,API_KEY));
        Timber.d("[apiRequestBiCityId] This is URL: " + sb.toString());
        return sb.toString();
    }
